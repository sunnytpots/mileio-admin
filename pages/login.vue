            ...
            <div class="login-form-body">
              <FormUi
                ...
                <v-text-field
                  ...
                  :rules="passwordRules"/>
                <span
                  v-if="isPasswordsNotMatch"
                  class="password-not-match">על אימות הסיסמה להיות תואם לסיסמה</span>
